...
# Run local with GPT-oss
Setup n8n locally  
Install Ollama  
Install gpt-oss (using Ollama)  
Hook up Ollama Chat Model inside n8n and start prompting  

```bash 
# Install n8n (Think of an "If-then" engine runtime you own using custom logic.)

# creates a volume to store persistent data
# downloads the required n8n image
# starts container, expose port 5678
# save work between container restart, mount to docker volume n8n_data 
...
# test gpt-oss model and ask a question
ollama run gpt-oss:latest 

# start server to serve ML models
ollama serve
#

# Open a browser, create a local user
# user: Mississippi0
http://localhost:5678/home/workflows

# To connect from n8n to docker ollama model 
# Change base url to http://host.docker.internal:11434

# Testing screenshots 


# n8n install and start logs 
$ docker volume create n8n_data
n8n_data
...
f5a4e2f4172e: Pull complete 
039df5c53d36: Pull complete 
2039203ec39b: Pull complete 
20fefe6c7ee4: Pull complete 
bc94faff6558: Pull complete 
aaca49a37c98: Pull complete 
18a1f1b4f547: Pull complete 
Digest: sha256:a49bc867def7800e99ec175dee46b62282961a6460cfb422b3adec3e53073d63
