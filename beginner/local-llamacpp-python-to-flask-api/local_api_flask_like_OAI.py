# source from: https://github.com/ggerganov/llama.cpp/blob/master/examples/server/api_like_OAI.py
# changed:
# added new route @app.route('/engines/deployment-name/chat/completions', methods=['POST'])
...
parser.add_argument("--api-key", type=str, help="Set the api key to allow only few user(default: NULL)", default="sk-42")
...
@app.route('/engines/deployment-name/chat/completions', methods=['POST'])
